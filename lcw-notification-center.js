  ...
  function createNotificationBellModal() {
    jQuery(
      ...
      <div class="modal" id="notificationBellModal"
        style="width: 5%; height: 10%; border-radius: 50%; overflow: visible; position: fixed; top: 10%; left: 95%;"
      >
        <div class="modal-dialog" style="width: 100%;">
          <div class="modal-content" style="border-radius: 10px;">
            <button type="button" class="btn btn-secondary" style="background-color: #A44476;">
